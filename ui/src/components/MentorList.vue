                ...
                <v-card class="elevation-9 my-4 rounded-card" :class="{ 'card-hover': isCardHovered === i }" @mouseover="isCardHovered = i" @mouseleave="isCardHovered = null">
                  <v-card-text>
                    <div class="mentor-info">
                      ...
                      <div class="headline">{{ mentor.first_name.charAt(0).toUpperCase() + mentor.first_name.slice(1) + ' ' + mentor.last_name.charAt(0).toUpperCase()+mentor.last_name.slice(1) }}</div>
